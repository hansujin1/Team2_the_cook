...
<body>
	<div class="bx_div">
		<ul class="bxslider">
			<!-- slide -->
			<li><img src="img/sliderImg2.jpg">
				<h1 class="mainText1">
					JOIN US! <br>더 많은 레시피를 공유해요
				</h1></li>
			<li><img src="img/sliderImg.jpg">
				<h1 class="mainText2">
					The Cook과 함께라면? <br> 어려운 요리도 뚝딱!
				</h1></li>
			<li><img src="img/tteokbokki.jpg">
				<h1 class="mainText3">
					Korean Food <br>
				</h1></li>
			<li><img src="img/sushi2.jpg">
				<h1 class="mainText4">
					Japanese Food <br>
				</h1></li>
			<li><img src="img/pasta3.jpg">
				<h1 class="mainText5">
					Western Food <br>
				</h1></li>

			<li><img src="img/Baking.jpg" style="">
				<h1 class="mainText6">
					Home Baking <br>
				</h1></li>
	...
	<div class="currentDiv">
		...
		<c:forEach var="p" items="${post}">
			...
			<div class="currentCont">
				...
				<img class="current_img"
					onclick="location.href='ShowPostDetailController?num=${p.board_number }'"
					src="fileFolder/${p.board_file}"> <span class="cc_id">${p.board_id}</span>
				<img class="cc_count" src="img/eyes.png">${p.board_count} <img
					class="cc_heart" src="img/heart.gif">${p.board_like}
			</div>
			...
			<div class="event_right">
				...
				<div class="event_txt">
					...
					<p class="event_label">
						...
						추첨하여<br> 감사의 마음을 담은 문화상품권을 증정하고 있습니다.<br> <br>
					</p>
					<p class="event_txt3">
	...
	<div class="arrow_wrapper"
		style="positon: fixed; z-index: 999;">
		<a href="#"> 
		<img class="arrow" src="img/UpArrow.png">
		<img class="hoverArrow" src="img/hoverArrow.png">
